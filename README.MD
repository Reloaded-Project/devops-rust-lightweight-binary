...
- **Nightly Rust**: Uses the latest nightly Rust toolchain by default for building and running. Toolchain can be overridden via `rust-toolchain` parameter to pin to a specific nightly version.
